...
class AnimalsNearYouFragment : Fragment() {
    ...
    private val viewModel: com.example.android.petsave.animalsnearyou.presentation.AnimalsNearYouFragmentViewModel by activityViewModels()
    ...
    private fun createInfiniteScrollListener(
        ...
        return object :
            com.example.android.petsave.animalsnearyou.presentation.InfiniteScrollListener(layoutManager,
    ...
    private fun updateScreenState(state: com.example.android.petsave.animalsnearyou.presentation.AnimalsNearYouViewState, adapter: AnimalsAdapter) {
