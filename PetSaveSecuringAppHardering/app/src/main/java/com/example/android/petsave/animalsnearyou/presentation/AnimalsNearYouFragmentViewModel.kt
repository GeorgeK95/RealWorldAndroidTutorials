...
import com.example.android.petsave.core.domain.usecases.GetAnimals
import com.example.android.petsave.core.domain.usecases.RequestNextPageOfAnimals
import com.example.android.petsave.core.presentation.Event
import com.example.android.petsave.core.presentation.model.mappers.UiAnimalMapper
import com.example.android.petsave.core.utils.DispatchersProvider
import com.example.android.petsave.core.utils.createExceptionHandler
...
class AnimalsNearYouFragmentViewModel @ViewModelInject constructor(
    ...
    fun handleEvent(event: com.example.android.petsave.animalsnearyou.presentation.AnimalsNearYouEvent) {
        when (event) {
            is com.example.android.petsave.animalsnearyou.presentation.AnimalsNearYouEvent.LoadAnimals -> loadNextAnimalPage()
        }
    }
